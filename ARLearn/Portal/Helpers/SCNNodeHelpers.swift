...
func makeFloorNode() -> SCNNode {
	...
	innerFloor.firstMaterial?.diffuse.contents = UIImage(named: "art.scnassets/floor/textures/Floor_Diffuse.png")
	innerFloor.firstMaterial?.normal.contents = UIImage(named: "art.scnassets/floor/textures/Floor_Normal.png")
	innerFloor.firstMaterial?.roughness.contents = UIImage(named: "art.scnassets/floor/textures/Floor_Roughness.png")
	innerFloor.firstMaterial?.specular.contents = UIImage(named: "art.scnassets/floor/textures/Floor_Specular.png")
	innerFloor.firstMaterial?.selfIllumination.contents = UIImage(named: "art.scnassets/floor/textures/Floor_Gloss.png")

	repeatTextures(geometry: innerFloor, scaleX: Float(SCALEX), scaleY: Float(SCALEY))
...
func makeCeilingNode() -> SCNNode {
	...
	innerCeiling.firstMaterial?.diffuse.contents = UIImage(named: "art.scnassets/ceiling/textures/Ceiling_Diffuse.png")
	innerCeiling.firstMaterial?.emission.contents = UIImage(named: "art.scnassets/ceiling/textures/Ceiling_Emis.png")
	innerCeiling.firstMaterial?.normal.contents = UIImage(named: "art.scnassets/ceiling/textures/Ceiling_Normal.png")
	innerCeiling.firstMaterial?.specular.contents = UIImage(named: "art.scnassets/ceiling/textures/Ceiling_Specular.png")
	innerCeiling.firstMaterial?.selfIllumination.contents = UIImage(named: "art.scnassets/ceiling/textures/Ceiling_Gloss.png")

	repeatTextures(geometry: innerCeiling, scaleX: Float(SCALEX), scaleY: Float(SCALEY))
...
func makeWallNode(length: CGFloat = WALL_LENGTH,
	...
	outerWall.firstMaterial?.transparency = 0.0000001

	let outerWallNode = SCNNode(geometry: outerWall)
	let multiplier: CGFloat = maskLowerSide ? -1 : 1
	outerWallNode.position = SCNVector3(WALL_HEIGHT * multiplier, 0, 0)
	...
	innerWall.firstMaterial?.diffuse.contents = UIImage(named: "art.scnassets/wall/textures/Walls_Diffuse.png")
	innerWall.firstMaterial?.metalness.contents = UIImage(named: "art.scnassets/wall/textures/Walls_Metalness.png")
	innerWall.firstMaterial?.roughness.contents = UIImage(named: "art.scnassets/wall/textures/Walls_Roughness.png")
	innerWall.firstMaterial?.normal.contents = UIImage(named: "art.scnassets/wall/textures/Walls_Normal.png")
	innerWall.firstMaterial?.specular.contents = UIImage(named: "art.scnassets/wall/textures/Walls_Spec.png")
	innerWall.firstMaterial?.selfIllumination.contents = UIImage(named: "art.scnassets/wall/textures/Walls_Gloss.png")
